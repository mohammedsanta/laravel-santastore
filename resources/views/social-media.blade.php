...
.social-1-main .discord {
  margin-top: -.9em;
  margin-left: -1.2em;
  fill: #8c9eff;
}

.social-1-main .card1:hover {
  cursor: pointer;
  scale: 1.1;
  background-color: #cc39a4;
}

.social-1-main .card1:hover .instagram {
  fill: white;
}

.social-1-main .card2:hover {
  cursor: pointer;
  scale: 1.1;
  background-color: #03A9F4;
}

.social-1-main .card2:hover .twitter {
  fill: white;
}

.social-1-main .card3:hover {
  cursor: pointer;
  scale: 1.1;
  background-color: black;
}

.social-1-main .card3:hover .github {
  fill: white;
}

.social-1-main .card4:hover {
  cursor: pointer;
  scale: 1.1;
  background-color: #8c9eff;
}

.social-1-main .card4:hover .discord {
  fill: white;
}

</style>

<div class="social-1-main">
  <div class="up">
    <button class="card1">
